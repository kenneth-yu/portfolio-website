        ...
        <Row className="centercenter">
          <Col style={{textAlign: "center"}} sm={6} >
            ...
            <p style={{paddingBottom: 20}}>Although I am not actively searching for new opportunities, I am always open for suggestions. 
                Feel free to send me a message using the button below or by messaging me at mail@kennethyu.dev. <br/> I will try my best to get back to you as soon as possible. Thanks for visiting my website!
            </p>
